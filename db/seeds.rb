...
accessory_products = [
  { name: "Embroidered Dupatta", price: 29.99, desc: "Beautiful embroidered dupatta to complement any ethnic outfit. Features delicate work and premium fabric." },
  { name: "Potli Bag", price: 34.99, desc: "Traditional potli bag with intricate beadwork. Perfect accessory for weddings and parties." },
  { name: "Kundan Jewelry Set", price: 79.99, desc: "Elegant Kundan jewelry set including necklace and earrings. Traditional design with contemporary appeal." },
  { name: "Silk Stole", price: 24.99, desc: "Luxurious silk stole available in various colors. Perfect for adding elegance to any outfit." },
  { name: "Jhumka Earrings", price: 19.99, desc: "Classic jhumka earrings with traditional design. Lightweight and comfortable for all-day wear." },
  { name: "Bangles Set", price: 14.99, desc: "Colorful bangles set perfect for traditional occasions. Available in various designs and colors." },
  { name: "Bindi Pack", price: 9.99, desc: "Assorted decorative bindis for special occasions. Multiple designs in one pack." }
]
...
bridal_products = [
  { name: "Bridal Lehenga Set", price: 799.99, desc: "Exquisite bridal lehenga with heavy embroidery and embellishments. Features premium fabrics and intricate craftsmanship. Includes lehenga, choli, and dupatta." },
  { name: "Wedding Sherwani", price: 599.99, desc: "Regal wedding sherwani with traditional embroidery. Perfect for grooms. Comes with matching churidar and dupatta." },
  { name: "Bridal Saree Collection", price: 449.99, desc: "Stunning bridal saree with heavy border work and embellishments. Traditional yet contemporary design." },
  { name: "Designer Bridal Suit", price: 399.99, desc: "Elegant bridal suit set with intricate embroidery. Perfect for wedding ceremonies and receptions." }
]
